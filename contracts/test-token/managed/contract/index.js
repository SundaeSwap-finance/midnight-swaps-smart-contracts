...
class _CoinPreimage_0 {
  alignment() {
    return _descriptor_8.alignment().concat(_descriptor_4.alignment().concat(_descriptor_5.alignment().concat(_descriptor_0.alignment())));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_8.toValue(value_0.domain_sep).concat(_descriptor_4.toValue(value_0.info).concat(_descriptor_5.toValue(value_0.dataType).concat(_descriptor_0.toValue(value_0.data))));
  }
}
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.randomNonce) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named randomNonce');
    }
    ...
    this.circuits = {
      mint: (...args_1) => {
        ...
        const coinPK_0 = args_1[3];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('mint',
                                     'argument 1 (as invoked from Typescript)',
                                     'test-token.compact line 7 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        if (!(typeof(coinPK_0) === 'object' && coinPK_0.bytes.buffer instanceof ArrayBuffer && coinPK_0.bytes.BYTES_PER_ELEMENT === 1 && coinPK_0.bytes.length === 32)) {
          __compactRuntime.typeError('mint',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(tokenColor_0).concat(_descriptor_1.toValue(amount_0).concat(_descriptor_2.toValue(coinPK_0))),
  ...
  _randomNonce_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.randomNonce(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('randomNonce',
                                 'return value',
                                 'test-token.compact line 5 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _mint_0(context, partialProofData, tokenColor_0, amount_0, coinPK_0) {
    this._mintShieldedToken_0(context,
                              partialProofData,
                              tokenColor_0,
                              amount_0,
                              this._randomNonce_0(context, partialProofData),
                              this._left_0(coinPK_0));
    return [];
  }
  _equal_0(x0, y0) {
...
const _dummyContract = new Contract({ randomNonce: (...args) => undefined });
